            ...
            <div className="ml-36  h-96  overflow-y-auto">
              ...
              {filteredCustomers.length > 0 ? (
                filteredCustomers.map((r, index) => (
                  <div
                    key={index}
                    className="bg-white shadow-lg hover:shadow-2xl ml-10 mb-5 cursor-pointer border border-gray-300 text-lg flex h-40 rounded-lg w-[1000px] transition-all duration-300"
                  >
